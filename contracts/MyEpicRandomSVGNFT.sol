...
contract MyEpicRandomSVGNFT is ERC721URIStorage {
    ...
    constructor() ERC721("Random 40k SVG NFT", "OrangutanMagicianLazers") {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        combinedWord,
                        '", "description": "A highly acclaimed collection of OrangutanMagicianLazers.", "image": "data:image/svg+xml;base64,',
